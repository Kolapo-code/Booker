...
dictionary = {
        "set1": {"id": "01", "name": "mery", "age": "12"},
        "set2": {"id": "02", "name": "mohamed", "age": "21"},
        "set3": {"id": "03", "name": "nife", "age": "33"}
	}

new = list(map(lambda a_set: dict(filter(lambda d: d[0] != "id" ,a_set.items())), dictionary.values()))
print(new)
